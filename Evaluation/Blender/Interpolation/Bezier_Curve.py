...
def main():
    ...
    """
    # Create a class to visualize a line segment.
    Bezier_Poly = Blender.Core.Poly_3D_Cls('Bezier_Poly', {'bevel_depth': 0.0015, 'color': [1.0,0.25,0.0,1.0]}, 
    ...
    """
    for i, (B_i, t_i) in enumerate(zip(B, B_Cls.x)):
        ...
        T = HTM_Cls(None, np.float64).Rotation(q.all(), 'QUATERNION').Translation(B_i)
