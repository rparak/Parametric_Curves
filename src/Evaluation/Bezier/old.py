...
import Lib.Manipulator.Utilities.Transformation as Transformation

import Lib.Manipulator.Interpolation.Bezier.Core as Bezier
...
_, axis = plt.subplots()
plt.plot(P[0,0], P[0,1], marker = 'o', ms = 5, mfc = [1,1,1], markeredgecolor = [0,0,0], mew = 2)
plt.plot(P[1,0], P[1,1], marker = 'o', ms = 5, mfc = [1,1,1], markeredgecolor = [0,0,0], mew = 2)
plt.plot(P[2,0], P[2,1], marker = 'o', ms = 5, mfc = [1,1,1], markeredgecolor = [0,0,0], mew = 2)
plt.plot(P[3,0], P[3,1], marker = 'o', ms = 5, mfc = [1,1,1], markeredgecolor = [0,0,0], mew = 2)

plt.plot(B_t_0[:, 0], B_t_0[:, 1], '--')

rec1 = pat.Rectangle(xy = (x_min_P, y_min_P), width = x_max_P - x_min_P, height = y_max_P - y_min_P, facecolor = 'none', edgecolor = 'red', linewidth = 2)
axis.add_patch(rec1)
...
x_min_cls = res[0][0]; x_max_cls = res[0][1]
y_min_cls = res[1][0]; y_max_cls = res[1][1]
